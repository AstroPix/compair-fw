...
*******************************************************************************/
(* ORIG_MODULE_NAME="clock_pll_1", LATTICE_IP_GENERATED="1" *) module clock_pll_1 (clki_i, 
        rstn_i, 
        pllpd_en_n_i, 
        clkop_o, 
        clkos_o, 
    ...
    output clkos3_o ; 
    output lock_o ; 
    clock_pll_1_ipgen_lscc_pll #(.INTFBKDEL_SEL("DISABLED"),
            ...
            .FRAC_N_EN(1),
            .FBK_MODE("INTCLKOP"),
            .FBCLK_DIVIDER_ACTUAL_STR("24"),
            .SSC_N_CODE_STR("0b000011000"),
            ...
            .CLKOS3_BYPASS(0),
            .ENCLKOS3_EN(0),
            .CLKOS3_FREQ_ACTUAL(10.0),
            .CLKOS3_PHASE_ACTUAL(0.0),
            .DIVOS3_ACTUAL_STR("119"),
            .DELD("119"),
            .PHID("0"),
            .CLKOS4_EN(0),
            .CLKOS4_BYPASS(0),
...
// Module : lscc_pll
//==========================================================================
module clock_pll_1_ipgen_lscc_pll #(parameter FVCO = 800.0, 
    ...
    generate
        if ((APB_EN == 1)) 
            begin : gen_apb
                ...
                ///
                clock_pll_1_ipgen_lscc_apb2lmmi #(.DATA_WIDTH(8),
                        .ADDR_WIDTH(8),
                ...
                if (APB_SOFT_REG_EN) 
                    begin : gen_csr
                        wire unused_w ; 
                        clock_pll_1_ipgen_pll_csr u_csr (// Inputs
                                .clk_i(apb_pclk_i), 
                                    .rst_n_i(apb_preset_n_i), 
...
// Module : pll_csr
//==========================================================================
(* LATTICE_IP_MODULE=1 *) module clock_pll_1_ipgen_pll_csr #(parameter SIMULATION = 0) (
    //--begin_param--
    //----------------------------
    // Parameters
    //----------------------------
...
//==========================================================================
module clock_pll_1_ipgen_lscc_apb2lmmi #(parameter DATA_WIDTH = 32, 
